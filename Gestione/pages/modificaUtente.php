                    ...
                    <form novalidate method="post" onsubmit="return validateForm()" autocomplete="new-password">
                        <div class="row ">
                            ...
                            <div class="col-4 p-2 bg-white">
                                <h4 class="pl-3 font-weight-bold">Modifica Utente</h4>
                            </div>
                                    ...
                                    <div class="col-4">
                                        <div class="bootstrap-select-wrapper">
                                            ...
                                            <select class="form-control" name="comune_residenza" title="Scegli un comune" data-live-search="true" data-live-search-placeholder="Cerca opzioni">
                                                <?php echo generaComboComuni($utente["comune_residenza"]); ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-4">
                        ...
                        <div class="row pt-3">
                            ...
                            <div class="col-4 bg-white align-middle">
                                <h4 class="pl-3 pt-1 font-weight-bold">Informazioni di accesso</h4>
                            </div>
                            <div class="col-6 bg-white p-1 text-right">
                                <div class="btn-example align-middle p-1">
