...
<body class="altezza-piena lightgrey-bg-c1">
    ...
    <div class="container pt-3">
        <div class="row shadow p-3 rounded bg-white m-1">
            <div class="col-2">
                <i class="fas fa-calendar-alt h1 text-danger"></i>
            </div>
            <div class="col-10">
    ...
    <div class="container pt-3">
        <div class="row shadow p-3 rounded bg-white m-1">
            <div class="col-2">
                <i class="fas fa-ambulance h1 text-danger"></i>
            </div>
            <div class="col-10">
    ...
    <div class="container pt-3">
        <div class="row shadow p-3 rounded bg-white m-1">
            <div class="col-2">
                <i class="fas fa-pump-medical h1 text-danger"></i>
            </div>
            <div class="col-10">
    ...
    <div class="container pt-3">
        <div class="row shadow p-3 rounded bg-white m-1">
            <div class="col-2">
                <i class="fas fa-envelope-open-text h1 text-danger"></i>
            </div>
            <div class="col-10">
